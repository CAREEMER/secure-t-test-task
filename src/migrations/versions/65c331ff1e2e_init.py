...
Revision ID: 65c331ff1e2e
Revises: 
Create Date: 2022-10-24 00:28:47.101941
...
def upgrade() -> None:
    ...
    sa.Column('index_in_thread', sa.SmallInteger(), nullable=False),
    sa.ForeignKeyConstraint(['author_id'], ['user.id'], ),
    ...
    sa.Column('positive', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['comment_uuid'], ['comment.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
